...
<div class="container-fluid">
	...
	<div class="row" id="content">
		...
		<!-- Nội dung từng mục -->
  		<div class="col-sm-10" style="background-color: #f1f1f1; overflow-y: scroll;">
  			...
  			<form class="import" action="./add_file_gv.php" method="POST" enctype="multipart/form-data">
  				<input type="file" name="addfile">
  				<button type="submit" class="btn btn-primary">IMPORT</button>
  			</form>
  			<form class="search" action="./admin_qlgiangvien.php" method="GET">
  			...
  			<table class="table" style="margin-top: 50px;">
	            ...
	            foreach ($resultb as $row){
			      ...
			      if (isset($_GET['magv'])) {
			      	$magv=$_GET['magv'];
				    include('../connect.php');
				   	$b = "SELECT * FROM tb_giaovien WHERE maGV='$magv'";
		            $resultb = $conn->prepare($b);
		            $resultb->execute();
		            foreach ($resultb as $row){
				      echo'<tr>
	...
	<div class="change_teacher" >
		<form action="./change_gv.php?idgv='.$_GET['idgv'].'" method="POST">
			<div class="row">
